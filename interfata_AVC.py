...
class AVCApp:
    def __init__(self, root):
        ...
        self.root.configure(bg="#DCEFF8")
        
        # Panoul cu mesajul de întâmpinare
        self.message_panel = tk.Frame(root, bg="#DCEFF8")
        ...
        self.recunoastere_button = ctk.CTkButton(
            ...
            hover_color="#0056b3",
            corner_radius=20,
            command=self.hide_button_and_start_recognition
        )
        self.recunoastere_button.pack(pady=20)

        # Etichetă pentru afișarea fluxului video
        self.video_label = tk.Label(root, bg="#DCEFF8")
    ...
    def hide_button_and_start_recognition(self):
         # Ascunde butonul
        self.start_diagnostic_thread()
    ...
    def run_diagnostic(self):
        ...
        if not alert_sent:
            ...
            self.result_label.config(text="Esti in regula! :)",
                                                     fg='green')
            self.message_label.config(text="Diagnosticare încheiată.\n Consultați medicul pentru detalii.")
